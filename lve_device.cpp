...
namespace lve {
    ...
    LveDevice::LveDevice(LveWindow &window) : lveWindow(window) {
        createInstance();
        setupDebugMessenger();
        createSurface();
        pickPhysicalDevice();
    ...
    LveDevice::~LveDevice() {
        ...
        vkDestroySurfaceKHR(instance, surfaceKhr_, nullptr);
    ...
    void LveDevice::createInstance() {
        ...
        applicationInfo.pEngineName = "Xuan";
    ...
    void LveDevice::pickPhysicalDevice() {
        VkPhysicalDevice pPhysicalDeviceT;
    ...
    uint32_t LveDevice::rateDeviceSuitability(VkPhysicalDevice device) {
        ...
        if (!deviceFeatures.geometryShader || !indices.graphicsFamilyHasValue || !indices.isComplete() ||
    ...
    SwapChainSupportDetails LveDevice::querySwapChainSupport(VkPhysicalDevice device) {
        ...
        vkGetPhysicalDeviceSurfaceCapabilitiesKHR(device, surfaceKhr_, &details.capabilitiesKhr);
        ...
        if (formatCount != 0) {
            ...
            vkGetPhysicalDeviceSurfaceFormatsKHR(device, surfaceKhr_, &formatCount, details.formats.data());
        }
    ...
    QueueFamilyIndices LveDevice::findQueueFamilies(VkPhysicalDevice device) {
        ...
        for (const auto &queueFamily: queueFamilies) {
            ...
            vkGetPhysicalDeviceSurfaceSupportKHR(device, i, surfaceKhr_, &presentSupport);
